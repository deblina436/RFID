			...
			for(int m=0;m<EPC.length;m++)
			{
				...
				if(inlist==false)
				{
					...
					try {
						...
						Connection conn = db.connect_to_db("Student_Management_System","tmilladminpostgresql","DataBase@1234");
						var url = "https://fastagmhlogin.icicibank.com/MTMSPG/GetTagDetails?SearchType=TagId&SearchValue=";
